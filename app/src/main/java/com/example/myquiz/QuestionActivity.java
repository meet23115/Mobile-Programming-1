...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void changeQuestion()
    {
       ...
       if (quesNum < questionList.size() - 1)
       {
           ...
           quesNum++;
            ...
            playAmin(option1, 0, 1);
            playAmin(option2, 0, 2);
            playAmin(option3, 0, 3);
            playAmin(option4, 0, 4);
    ...
    private void playAmin(View view, final int value, int viewNum)
    {
